# apply_runtime_updatefields_filter.py
# Menyuntikkan runtime patch di sales/wizard_v2.py:
# - Shim pdf_file (aman)
# - Filter update_fields saat FreightQuotation.save() dipanggil:
#   buang 'pdf_generated_at' dan 'pdf_file' + field tak-konkret lain
    ...
    try:
        ...
        def _fq_save(self, *args, **kwargs):
            ...
            if uf:
                ...
                # buang problem fields
                uf_set.discard("pdf_generated_at")
                uf_set.discard("pdf_file")
                # keep hanya concrete fields yang valid
                try:
